...
For contributing to OpenSourceCraft sewing patterns you need the following:
...
First fork the [opensourcecraft/sewing-patterns](https://github.com/opensourcecraft/sewing-patterns) repository to your personal Github account.
...
Either use the Github app for your operating system (mentioned above) or the `git` command line to get the repository locally. You get the repository address from the front page of your own Github repository fork:
    ...
    git clone git@github.com:yourgithubusername/sewing-patterns.git
...
If you are adding a new pattern, create a folder for it in the relevant sub-folder under 'sewing-patterns'.
...
Example:
    ...
    To git@github.com:yourgithubusername/sewing-patterns.git
